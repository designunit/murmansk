            ...
            <Layout>
                <Section style={{
                    ...
                    >
                        ...
                        <p>
                            Предлагаемый дизайн фиксирует и легализует неформальное популярное место и расширяет потенциал тропы вдоль откоса железной дороги, придаёт ему осмысленное завершение. он включает:
                        </p>
                        <ul>
                            <li>
                                подсыпку пешеходного прохода из инертного материала (щебня) - поверхность должна пропускать воду, иначе будут лужи
                            </li>
                            <li>
                                полосу деревянного настила вдоль пешеходного прохода - он делает пешеходный проход безопасным, и расширяет
                            </li>
                            <li>
                        ...
                        <p>
                        Примечательно, что площадка с освещенными погодозащищенными поворотными модулями будет служить приветственного знака тем, кто прибывает в город по железной дороге.
                        </p>
                        <p>
                        ...
                        <Section style={{
                            ...
                            <iframe
                                src={null} // "https://drive.google.com/file/d/1gnDLIPsL6OuM-UP8YBDZId_MPsAtGxT0/preview"
                                allow="autoplay"
