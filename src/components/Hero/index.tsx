                    ...
                    <Section style={{
                        ...
                        <div style={{
                            ...
                            <div className={s.flex}>
                                <div>
                                    <p>
                                        В этом году мы реализовали 5 площадок и вот-вот доделаем шестую: Маяковская площадка, <Link href={'/karla-libnekhta'}>склон Либнекхта с солнце-барабаном</Link> <Emoji name='🌞' />, <Link href={'/severny'}>площадка Северного проезда</Link> <Emoji name='🌆' />, <Link href={'/skver-shmidta'}>уши Шмидта</Link> <Emoji name='👂' />, <Link href={'/dostoevskogo'}>маяк Достоевской</Link> <Emoji name='⚓' /> и <Link href={'/kildinskaya'}>Кильдинская площадка</Link> <Emoji name='🏙️' />.
                                    </p>
                                    <p>
                                        На следующий год мы доведём до реализации <Emoji name='👷' /> самую сложную площадку первого сезона <Link href={'/abram-mys'}>Абрам-мыс</Link> и разработаем ещё пять: в Росляково, Росте, на Чумбарова-Лучинского, Орликовой и Баумана.
                                    </p>
                                    <p>
