                        ...
                        <div style={{
                            ...
                            <div className={s.flex}>
                                <div>
                                    ...
                                    <p>
                                        Мы разработали 5 концепций и презентовали их вам на живых встречах <Emoji name='🤝' />,  ниже вы можете ознакомиться с резюме <Emoji name='📄' /> и презентациями <Emoji name='📺' />, пока мы дорабатываем проекты и готовимся к реализации! <Emoji name='🚀' /> <Emoji name='🏁' /> <Emoji name='😮' />
                                    </p>
                                    <p>
                                        Кроме того, ближайшее время мы презентуем 6-ую площадку на Достоевского, а 7-ую площадку на Маяковской вы можете построить своими руками <Emoji name='👷' />, для этого записывайтесь на воркшоп от Общества Юных Архитекторов по ссылке ниже! <Emoji name='⤵️' />
                                    </p>
                                </div>
                            </div>
                        </div>
