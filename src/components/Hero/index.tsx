                    ...
                    <Section style={{
                        ...
                        <div style={{
                            ...
                            <div className={s.flex}>
                                <div>
                                    <p>
                                        В этом году мы реализовали 6 площадок: Маяковская площадка, <Link href={'/karla-libnekhta'}>«Склон Либкнехта», на сопке в районе ул. К.Либкнехта с солнце-барабаном</Link> <Emoji name='🌞' />, <Link href={'/severny'}>«Северная площадка», в районе дома № 21 на Северном проезде«Северная площадка», в районе дома № 21 на Северном проезде</Link> <Emoji name='🌆' />, <Link href={'/skver-shmidta'}>«Сквер Шмидта», вдоль ул.Шмидта</Link> <Emoji name='👂' />, <Link href={'/dostoevskogo'}>маяк Достоевской</Link> <Emoji name='⚓' /> и <Link href={'/kildinskaya'}>«Кильдинская площадка», в районе дома № 11 по ул.Кильдинской</Link> <Emoji name='🏙️' />.
                                    </p>
                                    <p>
