                    ...
                    <Section style={{
                        ...
                        <div style={{
                            ...
                            <div className={s.flex}>
                                <div>
                                    <p>
                                        В этом году мы реализовали 6 площадок: Маяковская площадка, <Link href={'/karla-libnekhta'}>склон Либнекхта с солнце-барабаном</Link> <Emoji name='🌞' />, <Link href={'/severny'}>площадка Северного проезда</Link> <Emoji name='🌆' />, <Link href={'/skver-shmidta'}>уши Шмидта</Link> <Emoji name='👂' />, <Link href={'/dostoevskogo'}>маяк Достоевской</Link> <Emoji name='⚓' /> и <Link href={'/kildinskaya'}>Кильдинская площадка</Link> <Emoji name='🏙️' />.
                                    </p>
                                    <p>
                                        В этом году мы планируем довести о реализации <Emoji name='👷' /> самую сложную площадку первого сезона <Link href={'/abram-mys'}>Абрам-мыс</Link> и реализовать <Emoji name='🤜' /> ещё 5 видовых площадок в Росляково, Росте, на Чумбарово-Лучинского, Орликовой и горе Горелой.
                                    </p>
                                    <p>
